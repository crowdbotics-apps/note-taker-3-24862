"""note_taker_3_24862 URL Configuration
...
admin.site.site_header = "Note taker 3"
admin.site.site_title = "Note taker 3 Admin Portal"
admin.site.index_title = "Note taker 3 Admin"

# swagger
api_info = openapi.Info(
    title="Note taker 3 API",
    default_version="v1",
    description="API documentation for Note taker 3 App",
)
